        ...
        <>
          ...
          >
            ...
            <div className="relative p-7">
              <button
                onClick={dismiss}
                className="absolute top-4 right-4 p-1.5 rounded-full text-tat-paper/40 hover:text-tat-paper transition-colors"
                aria-label="Dismiss"
              >
                <X className="h-4 w-4" />
              </button>
              ...
              <div className="inline-flex items-center gap-1.5 bg-tat-gold/20 border border-tat-gold/30 rounded-full px-3 py-1 mb-4">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-tat-gold font-medium">
                  Free trip planning
                </span>
              </div>

              <h3 className="font-display text-2xl text-tat-paper font-medium leading-tight text-balance">
                Before you go — tell us where you want to travel.
              </h3>
              <p className="mt-3 text-tat-paper/60 text-sm leading-relaxed">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <button
                  onClick={handlePlan}
                  className="flex-1 flex items-center justify-center gap-2 bg-tat-gold text-tat-charcoal py-3 rounded-full text-sm font-semibold hover:scale-[1.02] transition-transform"
                >
                ...
                <button
                  onClick={dismiss}
                  className="text-tat-paper/40 text-sm hover:text-tat-paper/70 transition-colors py-2 text-center"
                >
                  Maybe later
                </button>
              </div>
