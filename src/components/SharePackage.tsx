  ...
  return (
    <div className="relative">
      <button onClick={() => setOpen(!open)}
        className="flex items-center gap-1.5 text-[11px] px-3 py-1.5 rounded-full border border-ink/12 text-ink/50 hover:border-ink/30 hover:text-ink transition-all">
      ...
      {open && (
        <>
          ...
          <div className="absolute bottom-full mb-2 right-0 z-50 bg-white rounded-2xl shadow-soft-lg border border-ink/8 p-3 min-w-[200px]">
            <p className="text-[10px] uppercase tracking-[0.2em] text-ink/40 font-medium mb-2 px-1">Share this package</p>
            <div className="space-y-1.5">
              ...
              <button onClick={copy}
                className="flex items-center gap-2.5 w-full px-3 py-2 rounded-xl text-xs font-medium bg-ink/5 text-ink/70 hover:bg-ink/10 transition-colors">
