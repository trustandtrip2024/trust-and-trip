            ...
            {compareList.map((p) => (
              <div key={p.slug} className="relative group shrink-0">
                ...
                <button
                  ...
                  className="absolute -top-1.5 -right-1.5 h-4 w-4 rounded-full bg-tat-orange text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                >
