...
export default function FounderNote() {
  return (
    <section className="py-20 md:py-28 bg-sand/25" aria-labelledby="founder-heading">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
          {/* Photo — 5 cols */}
          <div className="md:col-span-5 order-1 md:order-none">
            <div className="relative aspect-[4/5] max-w-sm mx-auto md:mx-0 rounded-3xl overflow-hidden bg-ink/5">
              <Image
              ...
              {/* Floating card */}
              <div className="absolute bottom-4 left-4 right-4 bg-cream/95 backdrop-blur-sm rounded-2xl p-3 flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-gold/20 flex items-center justify-center shrink-0">
                  <span className="text-sm font-semibold text-ink">AM</span>
                </div>
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-ink leading-tight truncate">
                    Akash Mishra
                  </p>
                  <p className="text-[11px] text-ink/55 truncate">Founder, Trust and Trip</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-7">
            ...
            <Quote className="h-8 w-8 text-gold mb-5 opacity-60" />
            <h2 className="font-display text-2xl md:text-4xl leading-[1.15] font-medium text-ink text-balance">
              We started Trust and Trip because{" "}
              <span className="italic text-gold font-light">
                travel shouldn&apos;t feel transactional.
              </span>
            </h2>
            <div className="mt-6 space-y-4 text-ink/70 text-base leading-relaxed max-w-2xl">
              <p>
