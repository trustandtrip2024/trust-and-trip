    ...
    <section aria-labelledby="pillars-title" className="py-18 md:py-22">
      <div className="container mx-auto px-5 md:px-8 lg:px-12 max-w-7xl">
        <SectionHeader
          ...
          title="Three reasons travelers"
          italicTail="come back."
        ...
        <ul className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
          {PILLARS.map(({ icon: Icon, title, headline, body }) => (
        ...
        <p className="mt-10 text-center font-serif italic text-h4 text-stone-700 max-w-3xl mx-auto">
          Originality. Trust. Human care. Detail. The four values that built us — still the four we lead with.
        </p>
      </div>
    </section>
  );
