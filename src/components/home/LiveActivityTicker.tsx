...
const DISMISS_KEY = "tat_activity_ticker_dismissed_at";
...
export default function LiveActivityTicker() {
  ...
  if (onHidden || !visible || dismissed || exhausted) return null;
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed left-4 bottom-4 md:left-5 md:bottom-6 z-40 max-w-[260px] md:max-w-[320px] pointer-events-auto"
    >
