...
const STEPS = [
  {
    ...
    body: "Where, when, who's coming, and what you can't live without. A 2-minute form is all we need.",
  },
  {
    n: "02",
    title: "A planner reads it — really",
    body: "Not a bot. A named human at our office, who'll stay with you from enquiry through return.",
  },
  {
    n: "03",
    title: "Get a custom itinerary",
    body: "Usually within 24 hours. Edit it freely, switch hotels, change cities. Pay only when you're sure.",
  },
];
      ...
      <div className="container mx-auto px-5 md:px-8 lg:px-12 max-w-6xl">
        <div className="text-center">
          <SectionHeader
            ...
            title="Three steps. One planner."
            italicTail="Zero stress."
        ...
        <p className="mt-10 text-center font-serif italic text-h4 text-amber-700/80">
          Free until you&apos;re sure. That&apos;s the promise.
        </p>
