...
export default function DestinationCardUI({
  ...
  return (
    <Link
      href={href}
      className="group relative block aspect-[3/4] rounded-card overflow-hidden bg-stone-900 shadow-card transition duration-200 hover:shadow-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2"
    >
      <Image
        src={image}
        alt={name}
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 md:p-5 text-white">
        ...
        <p className="mt-1.5 font-serif italic text-meta text-amber-200/90 line-clamp-2">
          {whisper}
        </p>
        <div className="mt-3 flex items-center justify-between gap-2 text-meta">
          ...
          <span className="inline-flex items-center gap-1 text-white/85 group-hover:text-amber-300 transition duration-120">
            Explore
