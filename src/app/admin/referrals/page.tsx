      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="mb-8 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <Gift className="h-5 w-5 text-gold" /> Referrals
          </h1>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            <p className="text-sm font-semibold text-gray-700">{referrals.length} referrers</p>
          </div>
                ...
                {referrals.length === 0 ? (
                  ...
                  referrals.map((r) => (
                    <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{r.referrer_name}</td>
                      <td className="px-4 py-3 text-gray-500 max-w-[180px] truncate">{r.referrer_email}</td>
                      <td className="px-4 py-3 text-gray-500 whitespace-nowrap">{r.referrer_phone ?? "—"}</td>
                      <td className="px-4 py-3">
                        <code className="bg-gray-100 px-2 py-0.5 rounded text-xs font-mono text-gray-700">{r.code}</code>
                      </td>
                      <td className="px-4 py-3 text-center font-semibold text-gray-700">{r.clicks}</td>
