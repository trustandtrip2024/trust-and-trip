...
export default function TravellersPage() {
  ...
  return (
    <div>
      ...
      {/* Security banner */}
      <div className="bg-tat-success-bg border border-tat-success-fg/15 rounded-2xl px-4 py-3 flex items-start gap-3 mb-6">
        <ShieldCheck className="h-5 w-5 text-tat-success-fg shrink-0 mt-0.5" />
                    ...
                    <div key={t.id} className="bg-white rounded-2xl border border-tat-charcoal/8 p-4 hover:shadow-soft transition-all">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <button
                            ...
                            aria-label="Delete"
                            className="h-7 w-7 rounded-lg hover:bg-tat-danger-bg text-tat-charcoal/45 hover:text-tat-danger-fg flex items-center justify-center"
                          >
                      ...
                      {t.passport_number && (
                        <div className="mt-3 pt-3 border-t border-tat-charcoal/8 flex items-center justify-between gap-2 flex-wrap">
                          ...
                          {passportExpiring && (
                            <span className="inline-flex items-center gap-1 text-[10px] text-tat-warning-fg bg-tat-warning-bg px-1.5 py-0.5 rounded-full">
                    ...
                    <div key={d.id} className="p-4 flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button
                          ...
                          aria-label="Delete"
                          className="h-8 w-8 rounded-lg hover:bg-tat-danger-bg text-tat-charcoal/45 hover:text-tat-danger-fg flex items-center justify-center"
                        >
