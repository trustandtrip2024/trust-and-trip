  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        /* Generate code */
        <div className="bg-white rounded-2xl border border-tat-charcoal/8 p-8 text-center max-w-md mx-auto">
          <div className="h-14 w-14 rounded-2xl bg-tat-gold/10 flex items-center justify-center mx-auto mb-4">
            <Gift className="h-7 w-7 text-tat-gold" />
          </div>
          <h2 className="font-display text-xl font-medium text-tat-charcoal mb-2">Get your referral link</h2>
          ...
          <button
            onClick={generate}
            disabled={generating}
            className="flex items-center justify-center gap-2 w-full py-3.5 bg-tat-charcoal hover:bg-tat-gold text-tat-paper hover:text-tat-charcoal rounded-xl text-sm font-semibold transition-all disabled:opacity-60"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="bg-white rounded-2xl border border-tat-charcoal/8 p-4 text-center">
                ...
                <p className="font-display text-xl font-medium text-tat-charcoal">{value}</p>
                <p className="text-xs text-tat-charcoal/45 mt-0.5">{label}</p>
              </div>
            ))}
          </div>
          ...
          {/* How it works */}
          <div className="bg-tat-gold/5 border border-tat-gold/15 rounded-2xl p-5">
            <p className="text-sm font-semibold text-tat-charcoal mb-3">How it works</p>
