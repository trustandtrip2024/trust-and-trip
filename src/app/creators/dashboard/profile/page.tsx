  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="font-display text-2xl font-medium text-ink">Profile & payout</h1>
        <p className="text-sm text-ink/55 mt-1">Update your details and how you want to get paid.</p>
      </div>

      <div className="space-y-4">
        {/* Personal */}
        <form onSubmit={saveProfile} className="bg-white rounded-2xl border border-ink/8 p-5 md:p-6">
          ...
          <div className="mt-5 flex items-center gap-3">
            <button type="submit" disabled={savingProfile} className="flex items-center gap-2 px-5 py-2.5 bg-ink hover:bg-gold text-cream hover:text-ink rounded-xl text-sm font-semibold transition-all disabled:opacity-60">
        ...
        <div className="bg-gold/8 border border-gold/20 rounded-2xl p-5">
          <p className="text-[10px] uppercase tracking-widest text-ink/55 mb-1">Your code</p>
          <p className="font-display text-2xl font-medium text-ink font-mono">{creator.ref_code}</p>
          <p className="text-xs text-ink/55 mt-1">{creator.commission_pct}% commission per booking · cannot be changed</p>
        </div>

        {/* Change password */}
        <form onSubmit={changePassword} className="bg-white rounded-2xl border border-ink/8 p-5 md:p-6">
          <p className="text-sm font-semibold text-ink mb-5">Change password</p>
          <div className="max-w-sm">
            ...
            <div className="mt-4 flex items-center gap-3">
              <button type="submit" disabled={savingPw} className="flex items-center gap-2 px-5 py-2.5 bg-ink hover:bg-gold text-cream hover:text-ink rounded-xl text-sm font-semibold transition-all disabled:opacity-60">
