...
export const STYLE_PACKAGES: (PackageCardProps & { id: string; style: StyleId })[] = [
  ...
  make("rajasthan-family-7n8d",    "7N/8D Rajasthan heritage family",  "Rajasthan",   "Family",    "7N / 8D", 64000,  UNSPLASH("photo-1599661046289-e31897846e41"), 4.8, 211),
  ...
  make("ladakh-solo-7n8d",         "7N/8D Ladakh solo high-altitude",  "Ladakh",      "Solo",      "7N / 8D", 48000,  UNSPLASH("photo-1589553416260-f586c8f1514f"), 4.9, 64),
  ...
  make("ladakh-trek-7n8d",         "7N/8D Markha Valley trek",         "Ladakh",      "Adventure", "7N / 8D", 64000,  UNSPLASH("photo-1589553416260-f586c8f1514f"), 4.9, 58),
  ...
  make("zanskar-trek-8n9d",        "8N/9D Zanskar Valley trek",        "Ladakh",      "Adventure", "8N / 9D", 92000,  UNSPLASH("photo-1589553416260-f586c8f1514f"), 4.9, 31),
  ...
  make("coorg-wellness",           "5N/6D Coorg wellness escape",      "Coorg",       "Wellness",  "5N / 6D", 56000,  UNSPLASH("photo-1626015365107-3a71e18c5268"), 4.8, 52),
