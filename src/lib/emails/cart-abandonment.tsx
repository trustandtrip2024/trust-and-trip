      ...
      <body style={{ fontFamily: "sans-serif", background: "#FAF7F2", padding: "32px 16px", margin: 0 }}>
        <div style={{ maxWidth: 600, margin: "0 auto", background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 20px rgba(11,28,44,0.08)" }}>
          <div style={{ background: "#0B1C2C", padding: "32px", textAlign: "center" }}>
            ...
            <h1 style={{ color: "#FAF7F2", fontFamily: "Georgia, serif", fontSize: 24, margin: "8px 0 4px", fontWeight: 500 }}>
              {subjectLead}
            </h1>
            <p style={{ color: "#E8A94C", fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", margin: 0 }}>
              Trust and Trip
            </p>
          </div>
          ...
          <div style={{ padding: "32px" }}>
            ...
            {items.map((it, i) => (
              <div key={i} style={{ border: "1px solid rgba(11,28,44,0.08)", borderRadius: 12, padding: 16, marginTop: 16, display: "flex", gap: 14, alignItems: "center" }}>
                {it.packageImage && (
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: 14, fontWeight: 600, color: "#0B1C2C", margin: "0 0 4px" }}>
                    {it.packageTitle}
                  </p>
                  <p style={{ fontSize: 11, color: "rgba(11,28,44,0.55)", margin: "0 0 8px" }}>
                  ...
                  <p style={{ fontSize: 13, color: "#B88530", fontWeight: 600, margin: 0 }}>
                    ...
                    <span style={{ fontSize: 11, color: "rgba(11,28,44,0.5)", fontWeight: 400 }}> / person</span>
                  </p>
                </div>
              </div>
            ))}

            <div style={{ marginTop: 22, padding: "14px 18px", background: "#FAF7F2", borderRadius: 10, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontSize: 12, color: "rgba(11,28,44,0.6)", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Est. total
              </span>
              <span style={{ fontSize: 16, fontWeight: 600, color: "#0B1C2C" }}>
                {fmtINR(total)}
              </span>
            </div>

            <div style={{ textAlign: "center", margin: "28px 0 18px" }}>
              <a href={cartUrl} style={{ display: "inline-block", background: "#E8A94C", color: "#0B1C2C", padding: "14px 32px", borderRadius: 999, textDecoration: "none", fontWeight: 600, fontSize: 14 }}>
            ...
            <p style={{ fontSize: 11, color: "rgba(11,28,44,0.45)", marginTop: 28, lineHeight: 1.5, textAlign: "center" }}>
          ...
          <div style={{ background: "#FAF7F2", padding: "18px 32px", borderTop: "1px solid rgba(11,28,44,0.06)" }}>
            <p style={{ fontSize: 10, color: "rgba(11,28,44,0.45)", margin: 0, textAlign: "center" }}>
              <a href="https://trustandtrip.com/dashboard/cart" style={{ color: "rgba(11,28,44,0.55)", textDecoration: "none" }}>View cart</a>
              {" · "}
