      ...
      <body style={{ fontFamily: "sans-serif", background: "#FBF7F1", padding: "32px 16px", margin: 0 }}>
        <div style={{ maxWidth: 560, margin: "0 auto", background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 20px rgba(42,42,42,0.08)" }}>
          <div style={{ background: "#2A2A2A", padding: "36px 32px", textAlign: "center" }}>
            ...
            <h1 style={{ color: "#FBF7F1", fontFamily: "Georgia, serif", fontSize: 32, margin: "4px 0", fontWeight: 500 }}>
              {fmtINR(amountPaise)}
            </h1>
          ...
          <div style={{ padding: "32px" }}>
            ...
            {txnRef && (
              <div style={{ background: "#FBF7F1", border: "1px solid rgba(42,42,42,0.08)", borderRadius: 12, padding: "14px 18px", marginTop: 18 }}>
                <p style={{ fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(42,42,42,0.55)", margin: "0 0 6px", fontWeight: 600 }}>
                  Transaction reference
                </p>
                <p style={{ fontSize: 13, color: "#2A2A2A", fontFamily: "monospace", margin: 0, wordBreak: "break-all" }}>
                  {txnRef}
                </p>
              </div>
            )}
            ...
            <div style={{ textAlign: "center", margin: "26px 0 18px" }}>
              <a href={dashboardUrl} style={{ display: "inline-block", background: "#C8932A", color: "#2A2A2A", padding: "12px 28px", borderRadius: 999, textDecoration: "none", fontWeight: 600, fontSize: 14 }}>
                View earnings history
              </a>
            </div>

            <p style={{ fontSize: 12, color: "rgba(42,42,42,0.55)", marginTop: 24, lineHeight: 1.5 }}>
          ...
          <div style={{ background: "#FBF7F1", padding: "18px 32px", borderTop: "1px solid rgba(42,42,42,0.06)" }}>
            <p style={{ fontSize: 10, color: "rgba(42,42,42,0.45)", margin: 0, textAlign: "center" }}>
              <a href={dashboardUrl} style={{ color: "rgba(42,42,42,0.55)", textDecoration: "none" }}>Earnings</a>
              {" · "}
