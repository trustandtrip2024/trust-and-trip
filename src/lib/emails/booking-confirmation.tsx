      ...
      <body style={{ fontFamily: "sans-serif", background: "#FBF7F1", padding: "32px 16px", margin: 0 }}>
        <div style={{ maxWidth: 600, margin: "0 auto", background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 20px rgba(42,42,42,0.08)" }}>
          <div style={{ background: "#2A2A2A", padding: "36px 32px", textAlign: "center" }}>
            ...
            <p style={{ color: "#C8932A", fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", margin: "0 0 8px", fontWeight: 500 }}>
              Booking Confirmed
            </p>
            <h1 style={{ color: "#FBF7F1", fontFamily: "Georgia, serif", fontSize: 26, margin: "4px 0 6px", fontWeight: 500 }}>
          ...
          <div style={{ padding: "32px" }}>
            <p style={{ fontSize: 14, color: "#2A2A2A", lineHeight: 1.6, marginTop: 0 }}>
              Your deposit has been received and your trip is locked in. Save this email — it
              has everything you need.
            </p>

            <div style={{ border: "1px solid rgba(42,42,42,0.08)", borderRadius: 12, padding: 20, marginTop: 18 }}>
              <p style={{ fontSize: 18, fontWeight: 600, color: "#2A2A2A", margin: "0 0 14px" }}>
                {packageTitle}
              </p>
            ...
            <div style={{ display: "block", textAlign: "center", margin: "26px 0 18px" }}>
              <a href={bookingUrl} style={{ display: "inline-block", background: "#C8932A", color: "#2A2A2A", padding: "12px 28px", borderRadius: 999, textDecoration: "none", fontWeight: 600, fontSize: 14, marginRight: 8, marginBottom: 8 }}>
                View booking
              </a>
              <a href={receiptUrl} style={{ display: "inline-block", background: "#2A2A2A", color: "#FBF7F1", padding: "12px 24px", borderRadius: 999, textDecoration: "none", fontWeight: 600, fontSize: 14, marginBottom: 8 }}>
                Download GST invoice
              </a>
            </div>

            <div style={{ background: "#FBF7F1", border: "1px solid rgba(42,42,42,0.06)", borderRadius: 12, padding: "16px 18px", marginTop: 18 }}>
              <p style={{ fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(42,42,42,0.55)", margin: "0 0 8px", fontWeight: 600 }}>
                What happens next
              </p>
              <ol style={{ fontSize: 13, color: "#2A2A2A", margin: 0, paddingLeft: 18, lineHeight: 1.7 }}>
          ...
          <div style={{ background: "#FBF7F1", padding: "18px 32px", borderTop: "1px solid rgba(42,42,42,0.06)" }}>
            <p style={{ fontSize: 10, color: "rgba(42,42,42,0.45)", margin: 0, textAlign: "center" }}>
              <a href={bookingUrl} style={{ color: "rgba(42,42,42,0.55)", textDecoration: "none" }}>Booking</a>
              {" · "}
              <a href={receiptUrl} style={{ color: "rgba(42,42,42,0.55)", textDecoration: "none" }}>Receipt</a>
              {" · "}
...
function Row({ label, value, highlight, bold, mono, small }: { label: string; value: string; highlight?: boolean; bold?: boolean; mono?: boolean; small?: boolean }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", borderTop: "1px solid rgba(42,42,42,0.04)" }}>
      <span style={{ fontSize: 12, color: "rgba(42,42,42,0.55)" }}>{label}</span>
      <span style={{
        fontSize: small ? 10 : (bold ? 15 : 13),
        fontFamily: mono ? "monospace" : "sans-serif",
        wordBreak: mono ? "break-all" : "normal",
        color: highlight ? "#0F8B4F" : "#2A2A2A",
