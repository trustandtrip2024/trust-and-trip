      ...
      <body style={{ fontFamily: "sans-serif", background: "#FAF7F2", padding: "32px 16px", margin: 0 }}>
        <div style={{ maxWidth: 560, margin: "0 auto", background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 20px rgba(11,28,44,0.08)" }}>
          ...
          <div style={{ padding: "32px" }}>
            ...
            {tempPassword && (
              <div style={{ background: "#FAF7F2", border: "1px solid rgba(11,28,44,0.08)", borderRadius: 12, padding: "18px 20px", marginTop: 20 }}>
                <p style={{ fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(11,28,44,0.55)", margin: "0 0 10px", fontWeight: 600 }}>
                  Your login
                </p>
                <p style={{ fontSize: 13, color: "#0B1C2C", margin: "4px 0" }}>
                  <strong>Email:</strong> {email}
                </p>
                <p style={{ fontSize: 13, color: "#0B1C2C", margin: "4px 0", fontFamily: "monospace" }}>
                  <strong style={{ fontFamily: "sans-serif" }}>Temp password:</strong> {tempPassword}
                </p>
                <p style={{ fontSize: 11, color: "rgba(11,28,44,0.5)", margin: "10px 0 0" }}>
            ...
            {!tempPassword && (
              <div style={{ background: "#FAF7F2", border: "1px solid rgba(11,28,44,0.08)", borderRadius: 12, padding: "18px 20px", marginTop: 20 }}>
                <p style={{ fontSize: 13, color: "#0B1C2C", margin: 0 }}>
            ...
            <div style={{ textAlign: "center", margin: "26px 0 18px" }}>
              <a href={loginUrl} style={{ display: "inline-block", background: "#E8A94C", color: "#0B1C2C", padding: "12px 28px", borderRadius: 999, textDecoration: "none", fontWeight: 600, fontSize: 14 }}>
                Log in to dashboard
              </a>
            </div>

            <hr style={{ border: 0, borderTop: "1px solid rgba(11,28,44,0.08)", margin: "26px 0" }} />

            <p style={{ fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(11,28,44,0.55)", margin: "0 0 8px", fontWeight: 600 }}>
              Your referral details
            </p>
            <p style={{ fontSize: 13, color: "#0B1C2C", margin: "4px 0" }}>
              <strong>Ref code:</strong> <span style={{ fontFamily: "monospace", color: "#B88530" }}>{refCode}</span>
            </p>
            <p style={{ fontSize: 13, color: "#0B1C2C", margin: "4px 0", wordBreak: "break-all" }}>
              <strong>Share link:</strong> <a href={refLink} style={{ color: "#B88530", fontFamily: "monospace" }}>{refLink}</a>
            </p>
            <p style={{ fontSize: 12, color: "rgba(11,28,44,0.6)", lineHeight: 1.6, marginTop: 12 }}>
            ...
            <div style={{ marginTop: 24, padding: "16px 18px", background: "rgba(232,169,76,0.08)", border: "1px solid rgba(232,169,76,0.25)", borderRadius: 12 }}>
              <p style={{ fontSize: 12, color: "#0B1C2C", margin: 0, lineHeight: 1.5 }}>
          ...
          <div style={{ background: "#FAF7F2", padding: "18px 32px", borderTop: "1px solid rgba(11,28,44,0.06)" }}>
            <p style={{ fontSize: 10, color: "rgba(11,28,44,0.45)", margin: 0, textAlign: "center" }}>
              <a href={dashboardUrl} style={{ color: "rgba(11,28,44,0.55)", textDecoration: "none" }}>Dashboard</a>
              {" · "}
